    ...
    <div className="block w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
      ...
      <div className="relative overflow-x-auto">
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <tr className="bg-white hover:bg-opacity-5 dark:bg-gray-800">
              <th
                scope="row"
              ...
              <td className="px-6 py-4">
                <div className="flex gap-2 items-center">
                  <Image
                    ...
                    alt="Rounded avatar"
                  />
                  <p className="text-nowrap">Paul Gayle</p>
                </div>
              </td>
              <td className="px-6 py-4">Laptop</td>
              <td className="px-6 py-4">$2999</td>
              <td className="px-6 py-4">7th May 2023</td>
              <td className="px-6 py-4">
            ...
            <tr className="bg-white hover:bg-opacity-5 dark:bg-gray-800">
              ...
              <td className="px-6 py-4">
                <div className="flex">
                  <span className="flex w-3 h-3 me-3 bg-yellow-500 rounded-full"></span>
